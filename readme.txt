...
Create custom WooCommerce order statuses, inject beautiful status colors, and organize your store's fulfillment process.
...
4. Navigate to **WooCommerce > Custom Statuses** in your admin menu to start managing your statuses!
...
By default, your statuses are kept safe in your database. If you want to completely wipe all custom statuses upon deletion, you can enable "Uninstall Cleanup" in the plugin settings.
...
* Compliance: Separated the Pro workflow engine into a standalone premium add-on to comply with repository guidelines.

= 1.0.1 =
* Initial public release! Custom statuses and color injection.